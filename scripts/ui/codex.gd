...
const SUPER_RECIPES = [
	...
	{"w": "⚔️ 环绕剑刃", "s": "剑刃风暴", "cond": "环绕剑刃 Lv7 + 被动「生命强化」Lv5", "fx": "剑刃数量翻倍 + 旋转速度提升 + 击穿敌人"},
	{"w": "🎯 穿透箭", "s": "万箭齐发", "cond": "穿透箭 Lv7 + 被动「铁壁」Lv5", "fx": "同时发射 3 支箭 + 穿透 +8 + 攻速翻倍"},
	{"w": "🌋 岩浆", "s": "熔岩之心", "cond": "岩浆 Lv7 + 被动「护盾」Lv5", "fx": "岩浆区域永久存在 + 范围翻倍 + 伤害翻倍"},
]
